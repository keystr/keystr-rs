...
impl KeystrModel {
    ...
    pub fn get_security_warning_secret(&self) -> String {
        "I understand that if the little secret key leaks to the wrong hands, the entire identity is COMPROMISED irreversibly.\n \
    ...
    pub fn get_security_level_desc(level: SecurityLevel) -> String {
        match level {
            ...
            SecurityLevel::PersistEncryptedOnly => "!! Secret key may be persisted, but only encrypted using a passhrase I provide.".to_string(),
