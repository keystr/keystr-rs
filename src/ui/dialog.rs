...
/// A widget that centers a dialog window element over some base element
pub struct Dialog<'a, Message, Renderer> {
    base: Element<'a, Message, Renderer>,
    dialog: Element<'a, Message, Renderer>,
...
impl<'a, Message, Renderer> Dialog<'a, Message, Renderer> {
    ...
    pub fn new(
        ...
        dialog: impl Into<Element<'a, Message, Renderer>>,
    ) -> Self {
        Self {
            base: base.into(),
            dialog: dialog.into(),
    ...
    Message: Clone,
{
    ...
    fn diff(&self, tree: &mut Tree) {
        tree.diff_children(&[&self.base, &self.dialog]);
    }
