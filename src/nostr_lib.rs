...
use nostr::key;
use nostr::nips;
use nostr::prelude::sign_delegation;
use nostr::secp256k1;

use nostr::prelude::schnorr::Signature;
// use nostr::prelude::sha256::Hash as Sha256Hash;
...
pub enum Error {
    ...
    #[error(transparent)]
    Nip19Error(#[from] nips::nip19::Error),
    /// Error passed from NIP-26
    #[error(transparent)]
    Nip26Error(#[from] nips::nip26::Error),
...
mod test {
    ...
    use nostr::prelude::sha256::Hash as Sha256Hash;
    use nostr::prelude::Hash;
    use nostr::prelude::{FromBech32, Message, Secp256k1, SecretKey};
    use std::str::FromStr;
